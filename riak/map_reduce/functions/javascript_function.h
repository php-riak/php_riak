...
#ifndef RIAK_MAP_REDUCE__FUNCTIONS__JAVASCRIPT_FUNCTION__H__
#define RIAK_MAP_REDUCE__FUNCTIONS__JAVASCRIPT_FUNCTION__H__
...
#endif //RIAK_MAP_REDUCE__FUNCTIONS__JAVASCRIPT_FUNCTION__H__
