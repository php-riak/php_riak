...
?>
--EXPECTF--
Warning: Riak\Property\CommitHook::__construct() expects parameter 2 to be Riak\Property\ModuleFunction, %A
Warning: Riak\Property\CommitHookList::offsetSet() expects parameter 2 to be Riak\Property\CommitHook, %A
done!
